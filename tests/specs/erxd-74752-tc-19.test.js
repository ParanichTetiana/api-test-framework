...
const patientTemplate = require('../testdata/erdx_74752_tc_19.json');
...
const VALID_COLUMNS = ['REFUSAL', 'MISSED_APT', 'IS_ADMINISTERED', 'CONSENT_TO_REPORT', 'LOT_NUMBER'];
...
describe('NewRx Submission', () => {
  ...
  it('TC19 — Only LotNumber valid, all other rotatable fields invalid', async () => {
    try {
      ...
      // LotNumber persists its valid value; boolean flags persist Y regardless of validity
