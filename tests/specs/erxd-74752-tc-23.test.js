...
const patientTemplate = require('../testdata/erdx_74752_tc_23.json');
...
const VALID_COLUMNS = ['REFUSAL', 'MISSED_APT', 'IS_ADMINISTERED', 'CONSENT_TO_REPORT', 'DOSE_NUMBER'];
...
describe('NewRx Submission', () => {
  ...
  it('TC23 — Only DoseNumber valid, all other rotatable fields invalid', async () => {
    try {
      ...
      // DoseNumber persists its valid value; boolean flags persist Y regardless of validity
