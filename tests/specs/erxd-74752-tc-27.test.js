...
const patientTemplate = require('../testdata/erdx_74752_tc_27.json');
...
const VALID_COLUMNS = ['REFUSAL', 'MISSED_APT', 'IS_ADMINISTERED', 'CONSENT_TO_REPORT', 'VTRCKS_PROVIDER_PIN'];
...
describe('NewRx Submission', () => {
  ...
  it('TC27 — Only VtrcksProviderPin valid, all other rotatable fields invalid', async () => {
    try {
      ...
      // VtrcksProviderPin persists its valid value; boolean flags persist Y regardless of
