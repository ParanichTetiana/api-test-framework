...
const patientTemplate = require('../testdata/erdx_74752_tc_13.json');
...
const VALID_COLUMNS = ['REFUSAL', 'MISSED_APT', 'IS_ADMINISTERED', 'CONSENT_TO_REPORT', 'ADMINISTRATION_DATE'];
...
describe('NewRx Submission', () => {
  ...
  it('TC13 — Only AdministrationDate valid, all other rotatable fields invalid', async () => {
    try {
