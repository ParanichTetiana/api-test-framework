...
const patientTemplate = require('../testdata/erdx_74752_tc_29.json');
...
const VALID_COLUMNS = ['REFUSAL', 'MISSED_APT', 'IS_ADMINISTERED', 'CONSENT_TO_REPORT', 'COMORBIDITY_STATUS'];
...
describe('NewRx Submission', () => {
  ...
  it('TC29 — Only ComorbidityStatus valid, all other rotatable fields invalid', async () => {
    try {
      ...
      // ComorbidityStatus persists its valid value; boolean flags persist Y regardless of
