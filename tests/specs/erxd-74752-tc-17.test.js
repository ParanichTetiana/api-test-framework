...
const patientTemplate = require('../testdata/erdx_74752_tc_17.json');
...
const VALID_COLUMNS = ['REFUSAL', 'MISSED_APT', 'IS_ADMINISTERED', 'CONSENT_TO_REPORT', 'ROUTE_OF_ADMINISTRATION'];
...
describe('NewRx Submission', () => {
  ...
  it('TC17 — Only RouteOfAdministration valid, all other rotatable fields invalid', async () => {
    try {
      ...
      // RouteOfAdministration persists its valid value; boolean flags persist Y regardless of
